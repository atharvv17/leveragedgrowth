...
import { 
  Globe, CreditCard, Phone, Linkedin, Database, GitBranch, BookOpen 
} from 'lucide-react';
...
const SolutionsGrid: React.FC = () => {
  const solutions = [
    {
      ...
      description: [
        ...
        "AI chatbot integration for real-time lead capture.",
        "Custom-built landing pages with tracking."
      ],
    ...
    },
    {
      ...
      description: [
        ...
        "Data-driven ad creatives & landing page optimization.",
        "Automated lead nurturing & tracking."
      ],
      ctaText: "Book a Call",
      ctaLink: "https://calendly.com/leveragegrowthbiz/30min",
    ...
    },
    {
      ...
      description: [
        ...
        "Natural-sounding AI voice agents for qualification.",
    ...
    },
    {
      ...
      description: [
        ...
        "AI-driven direct outreach & engagement strategy.",
        "DM scripts & content calendar for nurturing leads."
      ],
    ...
    },
    {
      ...
      description: [
        ...
        "Integration with email, chatbots & CRMs.",
    ...
    },
    {
      ...
      description: [
        ...
        "Sales psychology, objection handling & closing techniques.",
        "Roleplay sessions & sales scripts for optimization."
      ],
  ...
  return (
    <section className="py-10 px-6 md:px-12 lg:px-24 relative">
